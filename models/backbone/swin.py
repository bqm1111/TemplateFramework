...
class swin_s(SwinTransformer):
    def __init__(self, **kwargs):
        super().__init__(pretrain_img_size=224, patch_size=4, in_chans=3, embed_dim=96, depths=[2, 2, 18, 2], num_heads=[3, 6, 12, 24],
                         window_size=7, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.3, drop_path_rate=0.1,
                         norm_layer=nn.LayerNorm, ape=False, patch_norm=True, out_indices=(0, 1, 2, 3), frozen_stages=-1, use_checkpoint=True)


class swin_b384(SwinTransformer):
    def __init__(self, **kwargs):
        super(swin_b384, self).__init__(pretrain_img_size=384, patch_size=4, in_chans=3, embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32],
                                        window_size=12, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.3, drop_path_rate=0.1,
                                        norm_layer=nn.LayerNorm, ape=False, patch_norm=True, out_indices=(0, 1, 2, 3), frozen_stages=-1, use_checkpoint=True)


class swin_b224(SwinTransformer):
    def __init__(self, **kwargs):
        super(swin_b224, self).__init__(pretrain_img_size=224, patch_size=4, in_chans=3, embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32],
                                        window_size=7, mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0.3, drop_path_rate=0.1,
...
if __name__ == '__main__':
    model = swin_b384()
    model.init_weights(
        pretrained="checkpoint/swin_base_patch4_window12_384_22k.pth")
