...
class DDP(nn.Module):
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        gt_down = F.interpolate(gt_semantic_seg.float(),
        ...
        loss_decode = self._decode_head_forward_train(
            [feat], input_times, img_metas, gt_semantic_seg)
    ...
    def ddim_sample(self, x, img_metas):
        ...
        for idx, (times_now, times_next) in enumerate(time_pairs):
            ...
            mask_logit = self._decode_head_forward_test(
                [feat], input_times, img_metas=img_metas)  # [bs, 150, ]
